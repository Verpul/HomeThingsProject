...
VALUES ('Напоминание без даты окончания', null, null, null, null, null, null, null, false, null, null, false),
       ...
       ('Подзадача второго уровня', null, null, null, null, null, 8, 1, false, null, null, false),
       ('Подзадача второго уровня с подзадачей', null, null, null, null, null, 8, 1, false, null, null, false),
       ('Подзадача третьего уровня c подзадачами', null, null, null, null, null, 10, 2, false, null, null, false),
       ('Подзадача четвертого уровня 1', null, null, null, null, null, 11, 3, false, null, null, false),
       ('Подзадача четвертого уровня 2', null, null, null, null, null, 11, 3, false, null, null, false),
       ('Подзадача с периодичностью в 6 месяцев', '2025-01-01', null, null, null, null, null, null, true, 'MONTH', 6, false),
       ('Подзадача с периодичностью 1 год и напоминанием', '2025-01-01', '2024-06-06', null, null, null, null, null, true, 'YEAR', 1, false),
       ('Выполненная задача', null, null, null, null, null, null, null, false, null, null, true),
       ('Выполненная задача с категорией', null, null, null, 1, null, null, null, false, null, null, true);
