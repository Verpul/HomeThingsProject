...
public class WeightRecordTestData {
    public static final WeightRecord weightRecordOne = new WeightRecord(LocalDate.parse("2023-01-01"), "65.5");
    public static final WeightRecord weightRecordTwo = new WeightRecord(LocalDate.parse("2023-01-01"), "70.1");
    public static final WeightRecord weightRecordThree= new WeightRecord(LocalDate.parse("2023-01-01"), "68");
